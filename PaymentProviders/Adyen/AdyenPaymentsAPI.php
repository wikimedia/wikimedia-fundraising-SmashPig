    ...
    public function __construct( $account ) {
        ...
        $this->soapClient = new WSDL\Payment(
            ...
            array(
                 ...
                 'login' => Configuration::getDefaultConfig()->val( "payment-provider/adyen/accounts/{$this->account}/ws-username" ),
                 'password' => Configuration::getDefaultConfig()->val( "payment-provider/adyen/accounts/{$this->account}/ws-password" ),
            )
        );
    }
