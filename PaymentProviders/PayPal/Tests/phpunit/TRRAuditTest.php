...
class TRRAuditTest extends AuditTest {
	...
	public function testRejectGravyNotEmitted(): void {
		// Port of: test_reject_gravy (normalization-only interpretation)
		$output = $this->processFile( 'trr_gravy_donation.csv' );
		$this->assertCount( 0, $output, 'Gravy donation should not be emitted' );
	}
